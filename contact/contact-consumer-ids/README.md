...
flowchart LR
    ...
    subgraph consumer-ids["contact-consumer-ids"]
...
spring:
  kafka:
    ...
    consumer:
      group-id: ${KAFKA_CONSUMER_GROUP_ID:contact-consumer-ids}
...
| `KAFKA_CONSUMER_GROUP_ID` | Consumer group ID | `contact-consumer-ids` |
...
```bash
# From project root
mvn clean package -DskipTests -pl contact-common,contact-consumer-ids -am
...
# With Java
java -jar target/contact-consumer-ids-0.0.1-SNAPSHOT.jar
